...
export default function Todo({todo, isDeleted, isToggle} : TodoProps) {
    return (
        <div className="w-full flex items-center gap-2 mb-4 p-4 border-b border-gray-400">
            ...
            <IconButton  className="text-xl w-32 h-32" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}><i className="fas fa-edit"></i></IconButton>
